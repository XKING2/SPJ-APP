...
@section('pageheads')
<h1 class="h3 mb-4 text-gray-800">Kelola Data Kwitansi GU</h1>
@endsection
    ...
    <div class="card shadow mb-4">
        ...
        <div class="card-body">
            ...
            <div class="d-flex justify-content-between mb-3">
                <form action="{{ route('Kwitansigu') }}" method="GET" class="form-inline">
                            ...
                            <tr>
                                ...
                                <td>
                                    <div class="position-relative d-inline-block">
                                        ...
                                        <a href="{{ route('kwitansiGu.edit', $kwitansi->id) }}" 
                                        class="btn btn-sm btn-success btn-edit"
                                        data-edit-url="{{ route('kwitansiGu.edit', $kwitansi->id) }}">
