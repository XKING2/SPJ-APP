...
@section('pageheads')
    <h1 class="h3 mb-4 text-gray-800">Kelola Data Pesanan LS</h1>
@endsection
    ...
    <div class="card shadow mb-4">
        ...
        <div class="card-body">
            ...
            <div class="d-flex justify-content-between mb-3">
                <form action="{{ route('pesananls') }}" method="GET" class="form-inline">
                        ...
                        @forelse ($pesanans as $index => $pesanan)
                            <tr>
                                ...
                                <td>
                                    ...
                                    <a href="{{ route('pesananls.edit', $pesanan->id) }}" 
                                       class="btn btn-sm btn-success btn-edit"
                                       data-edit-url="{{ route('pesananls.edit', $pesanan->id) }}">
