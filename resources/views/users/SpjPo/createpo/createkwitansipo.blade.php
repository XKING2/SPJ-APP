...
<div class="container">
    <div class="card shadow-sm rounded-3">
        <div class="card-body">
            <form action="{{ route('kwitansiGu.store') }}" method="POST" novalidate>
                @csrf
                ...
                <div class="mb-3">
                    ...
                    <div class="input-group">
                        <select name="kwitansi_keg_id" id="kwitansi_keg_id"
                            class="form-control">
...
<script>
document.getElementById('addBukti').addEventListener('click', function () {
