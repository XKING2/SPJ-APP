            ...
            <div id="content">
                ...
                <div class="container-fluid">
                     ...
                     <div id="loading-screen" 
                        ...
                        <div id="loader-box" 
                            style="position: relative; background: white;  border-radius: 20px;  box-shadow: 0 4px 10px
                             rgba(0,0,0,0.2);  padding: 10px; width: 80px;  height: 80px;  display: flex;  align-items: center; justify-content: center; overflow: hidden;">
                            
                            <div id="lottie-container" 
                                style="position: absolute; width: 70;  height: 70px;  transform: scale(1.5);  top: 50%; 
                                left: 50%; transform: translate(-50%, -50%) scale(1.5);">
                            </div>
                        </div>
                    </div>
