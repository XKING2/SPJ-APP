...
{
    public function showvalidasiLS(Request $request)
    {
        ...
        return view('superadmins.validasi.validasils', compact(
            'spjs',
            'tahunDipilih',
            'minTahunDb',
            'maxTahunDb'
    ...
    public function showvalidasiGU(Request $request)
    {
        $search = $request->input('search');
        ...
        return view('superadmins.validasi.validasigu', compact('spjs'));
    }

    public function showvalidasiPO(Request $request)
    {
        ...
        return view('superadmins.validasi.validasipo', compact('spjs'));
    }
}
